...
const Productdetailinfo = ({currentItem,user,access}) => {
  ...
  console.log(" Productdetailinfo.user id ", companyDetails.user)
  console.log(" Productdetailinfo.product id ", currentItem.id)
 console.log(" Productdetailinfo.first_name ", user.first_name)
 console.log(" Productdetailinfo.last_name ", user.last_name)
 console.log(" Productdetailinfo.phone ", user.phone)
 console.log(" Productdetailinfo.email", user.email)
 console.log(" Productdetailinfo.name ", currentItem.name)
   const full_name = user.first_name.concat(user.last_name)
 console.log(" Productdetailinfo.company ", full_name)
