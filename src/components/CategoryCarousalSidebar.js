...
class CategoryCarousalSidebar extends Component {
  constructor(props) {
    super(props)
    this.state = {
      productCategories: [],
      ...
      await axios
        ...
        .then((res) => {
          ...
          res.data.map((item) => {
            ...
            this.props.itemSearchedCategoryWise(item, value)
  ...
  onSubmit = (e) => {
    ...
    this.props.itemSearchedCategoryWiseClear()
    filteredArray.map((item) => {
      return this.props.itemSearchedCategoryWise(item)
    })
  }
