...
const CategoryProducts = ({
  ...
  React.useEffect(() => {
    ...
    setNewUniqueList(itemSearchedCategoryWiseResult.filter(onlyUnique))
  }, [itemSearchedCategoryWiseResult])
  ...
  if (isAuthenticated) {
    ...
    if (itemSearchedCategoryWiseResult.length === 0) {
      return (
        <React.Fragment>
          <center
            className='container'
                    ...
                    <p>{item.details.slice(0, 90)}...</p>:
                     ...
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div className='rating'>
                          ...
                          &nbsp; &nbsp; {item.reviews.map((sub) => sub.rating)}
                        ...
                        <div className='price'>
                          ...
                          <h6 onClick={() => setValues(item)}>
                            <Link to='/product'> View more </Link>
                          </h6>
                        </div>
                        <br />
                        <div style={{ float: 'right' }}>
                          {item.company.leading_seller ? (
                            <React.Fragment>
                              <svg
                                width='24'
                                height='22'
      ...
      return (
        <React.Fragment>
          ...
          <h4
            ...
            className='title'
          >
            About {itemSearchedCategoryWiseResult.length} results found.
          </h4>
          <br />
          {itemSearchedCategoryWiseResult
            .filter((item) => item.approved === 'Approved ')
