...
const AdminPayouts = () => {
  ...
  const [declare, setDeclared] = React.useState(false)
      ...
      <table class='table table-striped'>
        <thead>
          <tr>
            ...
            {declare ? (
              <th scope='col'>
                <a href='#!' onClick={() => setDeclared(false)}>
                  Declared
                </a>
              </th>
            ) : (
              <th scope='col'>
                <a href='#!' onClick={() => setDeclared(true)}>
                  Undeclared
                </a>
              </th>
            )}
            <th scope='col'>Payout Generated </th>
